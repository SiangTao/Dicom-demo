...
public class Change {
    private static final Logger logger = LogManager.getLogger(Change.class);

    public static void main(String[] args) {
        int n = 825124;
        byte[] a = IntToByte(n);

        String[] s=ByteToBit(a);
        for(int i=0;i<4;i++){
            System.out.print(s[i]+" ");}

        //String[] s1 = ByteToBit(ByteToHex(a));

        //for (int i = 0; i < 8; i++) {
          //  System.out.print(s1[i] + " ");
        //}

        String s1=ByteToHex(a);
